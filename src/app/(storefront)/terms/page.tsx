...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-2 font-serif text-4xl font-semibold text-[#1C1C1C] mb-8">Terms & Conditions</h1>
      <div className="space-y-6 text-sm leading-relaxed text-[#6B6B6B]">
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">General</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Orders</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Pricing</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Intellectual Property</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Limitation of Liability</h2>
