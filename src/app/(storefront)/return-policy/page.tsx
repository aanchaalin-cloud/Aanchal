...
export default function ReturnPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-2 font-serif text-4xl font-semibold text-[#1C1C1C] mb-8">Return & Refund Policy</h1>
      <div className="space-y-6 text-sm leading-relaxed text-[#6B6B6B]">
        <p>Last updated: January 2025</p>
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Returns</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">How to Initiate a Return</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Refunds</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Exchanges</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Damaged or Defective Items</h2>
