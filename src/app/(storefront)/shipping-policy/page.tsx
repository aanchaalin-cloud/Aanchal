...
export default function ShippingPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-2 font-serif text-4xl font-semibold text-[#1C1C1C] mb-8">
        Shipping Policy
      </h1>
      <div className="space-y-6 text-sm leading-relaxed text-[#6B6B6B]">
        <p>Last updated: January 2025</p>

        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Processing Time</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Delivery Timeline</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Shipping Charges</h2>
        <ul className="list-disc list-inside space-y-1">
          <li>Free shipping on orders above ₹999</li>
          <li>₹99 flat shipping fee on orders below ₹999</li>
        </ul>

        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Shipping Partners</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Order Tracking</h2>
        ...
        <h2 className="font-serif text-xl font-semibold text-[#1C1C1C]">Damaged or Lost Shipments</h2>
